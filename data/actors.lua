...
goblin = {
    ...
    ore = {
        pattern = "USZ_HarvestNode_Ore",
        move_threshold = 8,  -- Adjust this value as needed
        interact_threshold = 2,  -- Adjust this value as needed
        interact_function = function(obj)
            interact_object(obj)
            console.print("Interacting with Ore Node")
        end
    }
